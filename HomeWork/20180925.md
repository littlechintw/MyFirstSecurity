...
# dd用法
```
dd if={INPUT} of={OUTPUT} skip={開啟位置}140147 bs={每次讀檔單位}1
```

# sCTF 2016 Q1 : banana-boy
```
~# binwalk carter.jpg
...
~# dd if=carter.jpg of=ans.jpg skip=140147 bs=1

54041+0 records in
54041+0 records out
54041 bytes (54 kB, 53 KiB) copied, 0.0971663 s, 556 kB/s
```
...
get string 'QklUU0NURg=='

~# strings black_hole.jpg
get string 'UQklUQ1RGe1M1IDAwMTQrODF9'
